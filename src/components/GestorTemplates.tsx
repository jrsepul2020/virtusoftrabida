...
import { Download, Upload, Copy, Save, Package, CheckCircle, AlertCircle, Loader2 } from 'lucide-react';
...
export default function GestorTemplates() {
    ...
    try {
      ...
      const template: Template = {
        ...
        configuracion: {
          ...
          configuracion_general: (config.data || []).reduce((acc, item) => {
  ...
  const importarConfiguracion = async (file: File) => {
    ...
    try {
      ...
      const configEntries = Object.entries(template.configuracion.configuracion_general);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-6 text-white">
        ...
        <p className="text-indigo-100">
          Exporta, importa y gestiona configuraciones predefinidas para competiciones
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="font-semibold text-gray-900 mb-1">Exportar Configuración</p>
          <p className="text-sm text-gray-600">Descarga la configuración actual como JSON</p>
          {exporting && (
        ...
        <label className="p-6 bg-white rounded-lg border-2 border-dashed border-gray-300 hover:border-green-500 hover:bg-green-50 transition-all cursor-pointer">
          ...
          <p className="font-semibold text-gray-900 mb-1">Importar Configuración</p>
          <p className="text-sm text-gray-600">Carga una configuración desde archivo</p>
          <input
            type="file"
            accept=".json"
            onChange={(e) => {
        ...
        >
          ...
          <p className="font-semibold text-gray-900 mb-1">Duplicar para Nueva Edición</p>
          <p className="text-sm text-gray-600">Crea configuración para próximo año</p>
        </button>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 bg-gray-50 border-b border-gray-200 flex items-center gap-3">
          ...
          <h3 className="font-semibold text-gray-900">Plantillas Predefinidas</h3>
        </div>
      ...
      <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold text-blue-900 mb-2">Cómo usar los templates</h4>
            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
              <li>Exporta tu configuración actual antes de importar una nueva</li>
              <li>Los templates sobrescriben la configuración existente</li>
              <li>Puedes editar los archivos JSON manualmente antes de importar</li>
              <li>Usa "Duplicar" para preparar la siguiente edición del concurso</li>
            </ul>
          </div>
        </div>
      </div>
