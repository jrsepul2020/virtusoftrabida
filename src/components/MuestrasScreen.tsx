  ...
  return (
    <div className="bg-white shadow-xl rounded-2xl p-4 sm:p-8 border border-gray-100">
      ...
      {samples.map((sample, idx) => (
        <div
          key={idx}
          className="mb-4 bg-gray-50 rounded-xl p-4 sm:p-6 border border-gray-100"
        >
          <div className="font-semibold mb-3 text-black text-base text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            <div>
              ...
              >
                ...
                <option value="ESPIRITUOSO ORIGEN VÍNICO">
                  ESPIRITUOSO ORIGEN VÍNICO
                </option>
                <option value="ESPIRITUOSO NO VÍNICO">
                  ESPIRITUOSO NO VÍNICO
                </option>
                <option value="ACEITE OLIVA VIRGEN EXTRA">
                  ACEITE OLIVA VIRGEN EXTRA
                </option>
                <option value="ACEITE OLIVA VIRGEN EXTRA ORGÁNICO">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4 pt-4">
        ...
        <button
          type="button"
          onClick={onNext}
          className="w-full sm:w-auto bg-black text-white px-8 py-2 rounded-lg font-semibold hover:bg-gray-800 transition-colors"
        >
          {t("button.next")}
        </button>
      </div>
