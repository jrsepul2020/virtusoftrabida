...
import { Building2, BarChart3, Layers, List, Users, Menu, X, Grid3X3, Mail, LogOut, FolderTree, LucideIcon, FileText, Smartphone, Settings, Camera, Trophy, CreditCard, Tag, Send, Barcode, ClipboardList, Download, Upload, Package } from 'lucide-react';
