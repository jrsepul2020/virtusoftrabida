/*
  ...
  - Re-enable Row Level Security on empresas and muestras tables
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added user_id column to empresas table';
  ELSE
    RAISE NOTICE 'user_id column already exists on empresas table';
  END IF;
END $$;
...
-- Create secure policies for empresas table
...
-- Create secure policies for muestras table
